...
<!--                            <li><a href="order_proposal.php">Orders</a></li>-->
                            ...
                            <li>
                                ...
                                {   
                                    ...
                                    <?php
                                        if($value['read_n']=='1'){
                                    ?>  <ul>
                                            <li style="font-weight: bold;"><a style="color: black; text-decoration: none;margin: 0px;padding: 0px;" href="customerValidation.php?notf=<?php echo $value['notification_id']; ?>&uname=<?php echo $value['cook_user_name']; ?>&order_id=<?php echo $value['order_id']; ?>"><?php echo $value['cook_user_name'].' '.$value['notification_details']; ?></a></li>
                                        </ul>
                                    <?php       
                                        }
                                        else
                                    ...
                                    ?>
                                            <ul>
                                                <li><a style="color: black; text-decoration: none;margin: 0px;padding: 0px;" href="customerValidation.php?notf=<?php echo $value['notification_id']; ?>&uname=<?php echo $value['cook_user_name']; ?>&order_id=<?php echo $value['order_id']; ?>"><?php echo $value['cook_user_name'].' '.$value['notification_details']; ?></a></li>
                                            </ul>
