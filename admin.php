               ...
               <div class="col-md-4 col-sm-4 col-xs-12"></div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <form class="form-container" method="post" action="admin.php">
                     <h3 style="color: white;font-style: italic;">Admin Login</h3>
                     <?php include('errors.php'); ?>
                     
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="uname" required>
                      ...
                      <button type="submit" class="btn btn-success btn-block" style="margin-top: 5px;" name="adminLogBtn">Login</button>
